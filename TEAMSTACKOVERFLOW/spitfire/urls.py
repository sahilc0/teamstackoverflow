...
urlpatterns = [
    ...
    url(r'^soundtrack/(?P<pk>[-\w]+)/lyric_comment$',views.commentLyric,name='lyric_comment'),
    url(r'^soundtrack/(?P<pk>[-\w]+)/track_comment$',views.commentTrack,name='track_comment'),
